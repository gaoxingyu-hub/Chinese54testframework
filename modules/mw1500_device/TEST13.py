...
#
class DialogTest13(QDialog, Ui_Dialog):
    """
    ...
    def __init__(self, parent=None):
        ...
        @type QWidget
        """
        super(DialogTest13, self).__init__(parent)
        self.setupUi(self)
        self.state = ''
        self.demo=True
    ...
    def on_pushButton_1_clicked(self):
        ...
        self.test_result.test_item = "频谱仪"
        self.test_result.test_condition = ''
        self.test_result.test_results = ''
        self.test_result.test_conclusion = 'PASS'
        QMessageBox.information(self, "提示", "频谱仪正常", QMessageBox.Ok)
    ...
    def on_pushButton_2_clicked(self):
        ...
        QMessageBox.information(self, "提示", "双工器故障", QMessageBox.Ok)
        self.signalTest.emit('test')
        self.close()
