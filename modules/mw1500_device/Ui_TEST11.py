...
"background-color:#E3EAF4;}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_1.setText(_translate("Dialog", "输出频率"))
        self.comboBox_1.setItemText(0, _translate("Dialog", "MHz"))
        self.label_2.setText(_translate("Dialog", "输出电平"))
        self.comboBox_2.setItemText(0, _translate("Dialog", "dBm"))
        self.label_3.setText(_translate("Dialog", "中心频率"))
        self.comboBox_3.setItemText(0, _translate("Dialog", "MHz"))
        self.label_5.setText(_translate("Dialog", "参考电平"))
        self.comboBox_5.setItemText(0, _translate("Dialog", "dBm"))
        self.label_4.setText(_translate("Dialog", "带宽"))
