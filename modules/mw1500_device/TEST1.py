...
from modules.mw1500_device.Ui_TEST13 import Ui_Dialog
import os
from PyQt5.QtCore import pyqtSignal
...
class DialogTest1(QDialog, Ui_Dialog):
    ...
    def on_pushButton_1_clicked(self):
        self.test_result.test_item = "被测设备监控接收到测试分机指令"
        self.test_result.test_condition = ''
        self.test_result.test_results = ''
        self.test_result.test_conclusion = 'PASS'
        QMessageBox.information(self, "提示", "监控单元正常", QMessageBox.Ok)
    ...
    def on_pushButton_2_clicked(self):
        ...
        QMessageBox.information(self, "提示", "监控单元故障", QMessageBox.Ok)
        self.signalTest.emit('test')
        self.close()
